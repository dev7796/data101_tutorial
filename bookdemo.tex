...
\section{Prediction Challenge 1}\label{prediction-challenge-1}}
...
\section{Prediction Challenge 2}\label{prediction-challenge-2}}
...
\section{Prediction Challenge 3}\label{prediction-challenge-3}}
...
\section{Boundless Analytics}\label{boundless-analytics}}
...
\hypertarget{DLL}{%
\chapter{Data League Leaderboard}\label{DLL}}
...
\textbf{Honourable Mentions: } Upsham Naik, Joshua B. Sze, Kirtan Patel, Maria Xu, Devam Patel, Eva Zhang, Toshanraju Vysyaraju, Maanas Pimplikar, Jared Chiou, Nitya Narayanan, Shrish Vellore, Yousra Belgaid, Mitali Shroff, Michael Jucan, Jackie Hong, Arvin Sung, Eric Xuan, Eva Allred, Leah Ranavat, Nami Jain, Gautam Agarwal, Aditya Patil

\hypertarget{data-puzzles-secrets}{%
\chapter{🔖 Data puzzles secrets}\label{data-puzzles-secrets}}
...
\section{Moody Data Puzzle}\label{moody-data-puzzle}}
...
\subsection{Secrets Revealed- Patterns in Professor Moody's data?}\label{secrets-revealed--patterns-in-professor-moodys-data}}
...
\subsection{Best Student's Submissions 2022}\label{best-students-submissions-2022}}
...
\section{Movies Data Hunt}\label{movies-data-hunt}}
...
\midrule
10217 & UK & PG & 6.97 & Medium & Medium & Action\\
10070 & UK & PG-13 & 7.06 & Low & Low & Action\\
3556 & USA & R & 6.77 & High & Medium & Action\\
480 & USA & PG-13 & 6.00 & High & High & Sci-Fi\\
1823 & USA & PG & 5.19 & High & High & Family\\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Secrets Revealed- Patterns in Movies data?}\label{secrets-revealed--patterns-in-movies-data}}
...
\subsection{Best Student's Submissions 2022}\label{best-students-submissions-2022-1}}
...
\section{Minimarket Data Hunt}\label{minimarket-data-hunt}}
...
\subsection{What were the secret associations between items in the minimarket?}\label{what-were-the-secret-associations-between-items-in-the-minimarket}}
...
\section{Predicting grades in Professor Moody's class}\label{predicting-grades-in-professor-moodys-class}}

\hypertarget{how-did-i-cook-the-professor-moody-prediction-challenge-data}{%
\subsection{How did I cook the Professor Moody Prediction challenge data?}\label{how-did-i-cook-the-professor-moody-prediction-challenge-data}}
...
\hypertarget{setting}{%
\section{Create New Project}\label{setting}}
...
\section{How to upload a data set?}\label{how-to-upload-a-data-set}}
...
\textbf{Note: } The directory path given here is the current working directory hosted on \emph{Github} where the dataset has been stored.
...
\tightlist
\item
  After making modifications to your saved file, you will need to save the file again. If the name of the file on the top is in { Red Color } indicates that the file have \textbf{unsaved} changes.
\end{itemize}
...
\section{General R References}\label{general-r-references}}

\url{https://www.w3schools.com/r/} \url{https://cran.r-project.org/doc/contrib/Short-refcard.pdf} \url{https://www.amazon.com/Statistics-Engineers-Scientists-William-Navidi/dp/0073376337/ref=pd_lpo_3?pd_rd_i=0073376337\&psc=1} \url{https://data101.cs.rutgers.edu/laboratory/}

\hypertarget{textbook-concepts}{%
\section{Textbook Concepts}\label{textbook-concepts}}
...
\section{R functions used in this class}\label{r-functions-used-in-this-class}}
...
\toprule
  & SCORE & GRADE & DOZES\_OFF & TEXTING\_IN\_CLASS & PARTICIPATION\\
\midrule
475 & 74.43 & B & sometimes & rarely & 0.58\\
442 & 34.69 & D & always & rarely & 0.05\\
337 & 49.55 & C & sometimes & never & 0.84\\
749 & 57.15 & C & never & never & 0.32\\
197 & 22.66 & F & never & always & 0.29\\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
  & country & content & imdb\_score & Gross & Budget & genre\\
\midrule
930 & USA & PG-13 & 5.21 & High & High & Family\\
9144 & USA & PG-13 & 8.01 & High & Medium & History\\
3050 & UK & PG-13 & 6.85 & Medium & High & Family\\
3868 & USA & PG-13 & 7.98 & High & Medium & Drama\\
6199 & UK & PG & 6.47 & Medium & Medium & Comedy\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
101 & Holland & weekday & 77.5\\
2324 & Lincoln & weekday & 62.0\\
2147 & Lincoln & weekday & 58.0\\
996 & Holland & weekday & 85.5\\
1143 & Holland & weekend & 60.5\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
3181 & 88558 & Costa Rica & 8.93\\
5866 & 34731 & Ghana & 5.38\\
4254 & 20306 & Tunisia & 2.66\\
3075 & 84745 & Sweden & 8.47\\
2204 & 56582 & South Korea & 6.69\\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Prediction 1 Dataset}\label{prediction-1-dataset}}
...
\midrule
603 & Economics & 40 & Junior & F\\
467 & Economics & 10 & Freshman & D\\
338 & CS & 18 & Senior & F\\
576 & Statistics & 37 & Junior & F\\
584 & Economics & 19 & Sophomore & F\\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Midterm, Project and Final Exam distribution in Prof.~Moody class}\label{midterm-project-and-final-exam-distribution-in-prof.-moody-class}}
...
\midrule
937 & 63 & 94 & 46 & 73.40000\\
777 & 92 & 54 & 94 & 72.57346\\
328 & 97 & 37 & 46 & 51.70000\\
24 & 56 & 18 & 63 & 39.97072\\
138 & 27 & 5 & 56 & 24.70000\\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Minimarket}\label{minimarket}}
...
\midrule
3545 & Ale & Weekend & Edison & Orange  Juice & Twix & None & Potato Chips\\
8635 & None & Weekend & Princeton & Cola & Twix & None & Pretzels\\
16084 & None & Weekday & Edison & None & Twix & White & None\\
18533 & Ale & Weekend & Metuchen & Orange  Juice & Milky Way & Red & None\\
7878 & None & Weekday & Edison & Cola & Twix & Red & None\\
\bottomrule
\end{tabular}
\end{table}
...
\subsection{Snippet 1}\label{snippet-1}}
...
\subsection{Snippet 2}\label{snippet-2}}
...
\subsection{Snippet 1}\label{snippet-1-1}}
...
\subsection{Snippet 2}\label{snippet-2-1}}
...
\subsection{Snippet 3}\label{snippet-3}}
...
\subsection{Snippet 1}\label{snippet-1-2}}
...
\subsubsection{What would R say?}\label{what-would-r-say}}
...
\subsubsection{What would R say?}\label{what-would-r-say-1}}
...
\section{Scatter Plot}\label{scartterplot}}
...
\hypertarget{barplot}{%
\section{Bar Plot}\label{barplot}}
...
\hypertarget{boxplot}{%
\section{Box Plot}\label{boxplot}}
...
\section{Mosaic Plot}\label{mosaicplot}}
...
\hypertarget{nrow}{%
\subsection{Snippet 1- example of subset function}\label{nrow}}
...
\subsection{Snippet 2- example of subset function}\label{snippet-2--example-of-subset-function}}
...
\subsection{Snippet 3- subset as subframe}\label{snippet-3--subset-as-subframe}}
...
\subsection{Snippet 4- subsetting columns}\label{snippet-4--subsetting-columns}}
...
\subsection{Snippet 5- sub-setting rows and columns}\label{snippet-5--sub-setting-rows-and-columns}}
...
\subsection{Code Review}\label{code-review-1}}

\hypertarget{what-would-r-say-2}{%
\subsubsection{What would R say?}\label{what-would-r-say-2}}
...
\subsubsection{What would R say?}\label{what-would-r-say-3}}
...
\subsection{Snippet 1- Example of tapply followed by barplot}\label{snippet-1--example-of-tapply-followed-by-barplot}}
...
\subsection{Code Review}\label{code-review-2}}

\hypertarget{what-would-r-say-4}{%
\subsubsection{What would R say?}\label{what-would-r-say-4}}
...
\section{Derived Attribute}\label{derived-attribute}}
...
\subsection{Snippet 1 - Making new categorical attribute.}\label{snippet-1---making-new-categorical-attribute.}}
...
\subsection{Code Review}\label{code-review-3}}

\hypertarget{what-would-r-say-5}{%
\subsubsection{What would R say?}\label{what-would-r-say-5}}
...
\subsubsection{What would R say?}\label{what-would-r-say-6}}
...
\subsubsection{What would R say?}\label{what-would-r-say-7}}
...
\subsubsection{More complex example of defining derived attributes}\label{more-complex-example-of-defining-derived-attributes}}
...
\paragraph{Snippet 1}\label{snippet-1-3}}
...
\hypertarget{ztest}{%
\chapter{🔖 Hypothesis Testing}\label{ztest}}
...
The \textbf{alternative hypothesis} states that Lincoln tunnel is more busy than Holland tunnel. Does observed data (observed traffic difference) provide us with enough evidence to \emph{reject null hypothesis} and in fact support the alternative hypothesis? To answer this question we need to decide whether the observed result is reasonably likely to come randomly under the condition that NULL hypothesis holds.

How likely it is that observed difference \texttt{(D=0.83)} comes \emph{randomly}? Permutation test helps us to estimate the chance that D=0.83 will come up randomly under the condition that traffic in Holland and Lincoln tunnels is equal.We can measure and observe it by running a permutation test, by randomly scrambling the traffic table.
...
\toprule
  & TUNNEL & DAY & VOLUME\_PER\_MINUTE\\
\midrule
298 & Holland & weekday & 74.5\\
464 & Holland & weekday & 88.5\\
37 & Holland & weekday & 116.5\\
2483 & Lincoln & weekend & 50.0\\
1335 & Holland & weekend & 51.5\\
\addlinespace
1784 & Lincoln & weekday & 60.0\\
2329 & Lincoln & weekday & 71.0\\
1204 & Holland & weekend & 59.5\\
1476 & Lincoln & weekday & 70.0\\
1214 & Holland & weekend & 72.5\\
\bottomrule
\end{tabular}
\end{table}
...
\section{Snippet 1: Permutation test}\label{permutaion}}
...
\section{Snippet 2: z-test}\label{snippet-2-z-test}}
...
\section{Snippet 3: Make your own data and see how p-value changes}\label{snippet-3-make-your-own-data-and-see-how-p-value-changes}}
...
Build the data frame with two attributes: \texttt{Cat\ and\ Val,\ using\ rnorm()\ function}. Our null hypothesis is that Group A and Group B have identical \textbf{mean(Val)}.

The alternative hypothesis is that the mean(Val) for Group B is higher than \textbf{mean(Val)} for Group A. We will change the mean and standard deviation of the data distributions for Group A and Group B and see how these changes affect the p-value. We will first use a permutation test and a single-step permutation test (just to illustrate what happens each single step when we run a permutation test). Then we finish off with the z-test.

\hypertarget{permuation-test}{%
\subsection{Permuation test}\label{permuation-test}}
...
\subsection{One permutation at a time}\label{one-permutation-at-a-time}}
...
\section{Additional References}\label{additional-references-1}}
...
\url{https://www.statisticshowto.com/probability-and-statistics/statistics-definitions/p-value/} \url{http://www.z-table.com/} \url{https://www.statisticshowto.com/probability-and-statistics/z-score/} \url{https://sixsigmastudyguide.com/z-scores-z-table-z-transformations/}

\hypertarget{chitest}{%
\chapter{🔖 Chi Square Analysis}\label{chitest}}
...
\section{Snippet 1}\label{snippet-1-4}}
...
\section{Snippet 2}\label{snippet-2-2}}
...
\section{Snippet 3}\label{snippet-3-1}}
...
\section{Snippet 4}\label{snippet-4}}
...
\hypertarget{Mtest}{%
\chapter{🔖 Multiple Hypothesis Testing}\label{Mtest}}
...
\toprule
  & IDN & COUNTRY & HAPPINESS\\
\midrule
3684 & 76126 & Spain & 7.33\\
2119 & 11166 & Laos & 2.51\\
1313 & 76155 & Sweden & 7.35\\
2806 & 34430 & Senegal & 4.63\\
2639 & 58455 & Trinidad and Tobago & 6.47\\
\addlinespace
1293 & 46842 & Bosnia and Herzegovina & 7.17\\
325 & 90028 & Vietnam & 8.27\\
1007 & 94534 & Netherlands & 9.77\\
4755 & 45586 & Yemen & 4.30\\
5968 & 48498 & Cameroon & 5.56\\
\bottomrule
\end{tabular}
\end{table}

\hypertarget{snippet-1---benjamini-hochberg-algorithm}{%
\section{Snippet 1 - Benjamini-Hochberg Algorithm}\label{snippet-1---benjamini-hochberg-algorithm}}
...
\section{Snippet 2}\label{snippet-2-3}}
...
\hypertarget{cr}{%
\chapter{Code Review: Exploratory Queries in R}\label{cr}}

\hypertarget{movies-dataset-example}{%
\section{Movies Dataset Example}\label{movies-dataset-example}}

\hypertarget{snippet-1-what-is-the-mean-imdb-of-low-budget-comedies}{%
\subsection{Snippet 1: What is the mean imdb of low budget comedies?}\label{snippet-1-what-is-the-mean-imdb-of-low-budget-comedies}}
...
\subsection{Snippet 2: What is standard deviation of imdb score of high gross Family movies?}\label{snippet-2-what-is-standard-deviation-of-imdb-score-of-high-gross-family-movies}}
...
\subsection{Snippet 3: What is the lowest imdb score among high budget movies?}\label{snippet-3-what-is-the-lowest-imdb-score-among-high-budget-movies}}
...
\subsection{Snippet 4: How many low budget movies generated high gross income?}\label{snippet-4-how-many-low-budget-movies-generated-high-gross-income}}
...
\subsection{Snippet 5: What is imdb score of the first non-US movie in the movies data frame?}\label{snippet-5-what-is-imdb-score-of-the-first-non-us-movie-in-the-movies-data-frame}}
...
\subsection{Snippet 6: What is the least frequent genre among UK movies?}\label{snippet-6-what-is-the-least-frequent-genre-among-uk-movies}}
...
\subsection{Snippet 7: Which content rating has the lowest average imdb score?}\label{snippet-7-which-content-rating-has-the-lowest-average-imdb-score}}
...
\subsection{Snippet 8: Movies from which country have the smallest average imdb score?}\label{snippet-8-movies-from-which-country-have-the-smallest-average-imdb-score}}
...
\subsection{Snippet 9: What is the least frequent genre in movies data frame?}\label{snippet-9-what-is-the-least-frequent-genre-in-movies-data-frame}}
...
\subsection{Snippet 10: z value = 2.4, whats the p-value?}\label{snippet-10-z-value-2.4-whats-the-p-value}}

eyJsYW5ndWFnZSI6InIiLCJzYW1wbGUiOiIxLXBub3JtKDIuNCkifQ==

\hypertarget{census-dataset-example}{%
\section{Census Dataset Example}\label{census-dataset-example}}

\hypertarget{snippet-11-for-the-individual-over-50-which-profession-has-the-highest-average-capital-gain}{%
\subsection{Snippet 11: For the individual over 50, which profession has the highest average capital gain?}\label{snippet-11-for-the-individual-over-50-which-profession-has-the-highest-average-capital-gain}}
...
\subsection{Snippet 12: Which profession has the highest average capital gains; Sales or Tech-support?}\label{snippet-12-which-profession-has-the-highest-average-capital-gains-sales-or-tech-support}}
...
\subsection{Snippet 13: What is most frequent profession of people with less than 10 years od of education?}\label{snippet-13-what-is-most-frequent-profession-of-people-with-less-than-10-years-od-of-education}}
...
\subsection{Snippet 14: What is minimum number of years of education for people with Exec-managerial specialty?}\label{snippet-14-what-is-minimum-number-of-years-of-education-for-people-with-exec-managerial-specialty}}
...
\subsection{Snippet 15: What is the most frequent degree for natives of the United States?}\label{snippet-15-what-is-the-most-frequent-degree-for-natives-of-the-united-states}}
...
\subsection{Snippet 16: What is the least frequent degree for people with at least 12 years of education?}\label{snippet-16-what-is-the-least-frequent-degree-for-people-with-at-least-12-years-of-education}}
...
\hypertarget{common}{%
\chapter{🔖 Common Sense Judgement and Probability}\label{common}}
...
\hypertarget{br}{%
\chapter{🔖 Bayesian Reasoning}\label{br}}
...
\section{Snippet 1: Covid Odds after positive Home Test.}\label{snippet-1-covid-odds-after-positive-home-test.}}
...
\section{Snippet 2: What are the odds that an `F' student is a freshman?}\label{snippet-2-what-are-the-odds-that-an-f-student-is-a-freshman}}
...
\section{Snippet 3: What are the odds that a `A' student with the score less than 80 is a psychology major?}\label{snippet-3-what-are-the-odds-that-a-a-student-with-the-score-less-than-80-is-a-psychology-major}}
...
\hypertarget{Pc1}{%
\chapter{🔖 Prediction Challenges}\label{Pc1}}
...
\section{General Structure of the Prediction Challenges}\label{general-structure-of-the-prediction-challenges}}
...
\section{Challenge 1 - Freestyle prediction of grades in yet another MOODY data set}\label{challenge-1---freestyle-prediction-of-grades-in-yet-another-moody-data-set}}
...
\textbf{Data League:} \url{https://data101.cs.rutgers.edu/?q=node/155} \textbf{Kaggle competition:} \url{https://www.kaggle.com/competitions/predictive-challenge-1-2022/overview} \textbf{Kaggle submission instructions:} \url{https://data101.cs.rutgers.edu/?q=node/150} \textbf{Canvas HW9:} \url{https://rutgers.instructure.com/courses/159918/assignments/1953810}

\hypertarget{challenge-2---same-data-but-using-rpart---decision-tree}{%
\section{Challenge 2 - Same data but using rpart - decision tree}\label{challenge-2---same-data-but-using-rpart---decision-tree}}
...
\textbf{Data League:} \url{https://data101.cs.rutgers.edu/?q=node/155} \textbf{Kaggle competition:} \url{https://www.kaggle.com/competitions/predictive-challenge-2-2022/overview} \textbf{Kaggle submission instructions:} \url{https://data101.cs.rutgers.edu/?q=node/150} \textbf{Canvas HW10:} \url{https://rutgers.instructure.com/courses/159918/assignments/1961012}

\hypertarget{P1}{%
\chapter{🔖 Free Style: Prediction}\label{P1}}
...
\section{Snippet 1: Example of a simple freestyle prediction model}\label{snippet-1-example-of-a-simple-freestyle-prediction-model}}
...
\section{Snippet 2: How to build a freestyle (your own code) prediction model?}\label{snippet-2-how-to-build-a-freestyle-your-own-code-prediction-model}}
...
\section{Snippet 3: One-step crossvalidation}\label{snippet-3-one-step-crossvalidation}}
...
\section{Snippet 4: Preparing submission.csv for Kaggle}\label{snippet-4-preparing-submission.csv-for-kaggle}}
...
\hypertarget{prpart}{%
\chapter{🔖 Predictions with rpart}\label{prpart}}
...
\hypertarget{rpart}{%
\section{Use of Rpart}\label{rpart}}
...
\section{Visualize the Decision tree}\label{rpartplot}}
...
\section{Rpart Control}\label{rpartcontrol}}
...
\subsection{Snippet 3: Minsplit = 200}\label{snippet-3-minsplit-200}}
...
\subsection{Snippet 4: Minsplit = 100}\label{snippet-4-minsplit-100}}
...
\subsection{Snippet 5: Minbucket = 100}\label{snippet-5-minbucket-100}}
...
\subsection{Snippet 6: Minbucket = 200}\label{snippet-6-minbucket-200}}
...
\subsection{Snippet 7: cp = 0.05}\label{snippet-7-cp-0.05}}
...
\subsection{Snippet 8: cp = 0.005}\label{snippet-8-cp-0.005}}
...
\includegraphics{https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/img/modeling/2022dt7.png} We can see for the output and the tree plot, that the tree size has increased, with increase in number of splits, and leaf nodes. Also we can see that the minimum CP value in the output is 0.005.

\hypertarget{crossvalidation}{%
\section{Cross Validation}\label{crossvalidation}}
...
We will pass the tree with formula as \texttt{GRADE\ \textasciitilde{}\ SCORE+DOZES\_OFF+TEXTING\_IN\_CLASS+PARTICIPATION}, and control parameter, with \texttt{minsplit=100}. And for cross\_validate() function, we will use\texttt{n\_iter=5,\ and\ split\_raitio=0.7}
...
\subsection{Snippet 9}\label{snippet-9}}
...
\section{Prediction using rpart.}\label{rpartpredict}}
...
\subsection{Snippet 10}\label{snippet-10}}
...
\section{Snippet 11: Your Model with rpart}\label{snippet-11-your-model-with-rpart}}
...
\section{Snippet 12: Freestyle + rpart: Combining rpart prediction models}\label{snippet-12-freestyle-rpart-combining-rpart-prediction-models}}
...
\section{Snippet 13: Submission with rpart}\label{snippet-13-submission-with-rpart}}
...
\hypertarget{lr}{%
\chapter{🔖 Linear Regression}\label{lr}}
...
\hypertarget{lm}{%
\section{Linear regression using lm() function}\label{lm}}
...
\hypertarget{mse}{%
\section{Calculating the Error using mse()}\label{mse}}
...
\section{Snippet 2: Cross Validate your prediction}\label{snippet-2-cross-validate-your-prediction}}
...
\section{Snippet 3: Submission with lm}\label{snippet-3-submission-with-lm}}
...
\hypertarget{MLP}{%
\chapter{🔖 Machine Learning-Prediction Loop}\label{MLP}}
...
\hypertarget{MAD}{%
\chapter{🔖 How can data fool us?}\label{MAD}}
...
\hypertarget{dsaf}{%
\chapter{Boundless Analytics - Pre-discovery Tool}\label{dsaf}}
...
\section{Minimarket Data Set description}\label{minimarket-data-set-description}}

Zoom recording

\hypertarget{demo-of-boundless-analytics}{%
\section{Demo of Boundless Analytics}\label{demo-of-boundless-analytics}}

Zoom Recording

\hypertarget{the-boundless-analytics-web-application}{%
\section{The Boundless Analytics web application}\label{the-boundless-analytics-web-application}}
...
\section{Snippet 1: Chi square hunt}\label{snippet-1-chi-square-hunt}}
