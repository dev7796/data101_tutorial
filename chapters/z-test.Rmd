...
- **Great Resource: **     <button class="btn btn-primary" data-toggle="collapse" data-target="#HPT12">Khan Academy</button> 
<div id="KH12" class="collapse">
<embed src="https://www.khanacademy.org/math/statistics-probability/significance-tests-confidence-intervals-two-samples/comparing-two-means/v/hypothesis-test-for-difference-of-means" width="100%" height="500px"></embed>
</div>
