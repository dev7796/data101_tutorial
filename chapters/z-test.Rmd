...
In the snippet **8.2**  we end up calculating the p-value which leads to rejection of Null hypothesis (good news for data scientist, bad for the sceptic).  Indeed, p-value is less than the significance level  of 5%.
...
```{r,tut=TRUE,ex="ztestfunction",type="sample-code",height=500}
...
## Snippet 4: One permutation at a time
