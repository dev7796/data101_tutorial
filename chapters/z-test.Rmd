...
```
<br>
The following snippet 6.1.1 shows the code  for hypothesis test of difference of means.
...
In the snippet 6.1.1  we end up calculating the p-value which leads to rejection of Null hypothesis (good news for data scientist, bad for the sceptic).  Indeed, p-value is less than the significance level  of 5%.
