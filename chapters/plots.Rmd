...
1. **Lecture slides: Plots**     <button class="btn btn-primary" data-toggle="collapse" data-target="#plots11">Lecture PPT</button>
<button class="btn btn-primary" data-toggle="collapse" data-target="#plots111">Google Slides</button>
