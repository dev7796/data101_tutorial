...
<button class="btn btn-primary" data-toggle="collapse" data-target="#plots12">Google Slides</button>
<div id="plots11" class="collapse">    
<embed src="https://docs.google.com/viewer?url=https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/pred/Plots-2022.pdfx&embedded=true" width="100%" height="500px"></embed>
</div>
<br>
