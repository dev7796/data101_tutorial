...
<embed src="https://www.khanacademy.org/math/ap-statistics/chi-square-tests/chi-square-goodness-fit/v/chi-square-statistic" width="100%" height="500px"></embed>
</div>

<br>

- **Great resource: **     <button class="btn btn-primary" data-toggle="collapse" data-target="#KS12">Khan Academy</button> 
<div id="KS12" class="collapse">
