...
- There are two options while accessing the dataset from your local machine:
  ...
  2. One can also store the dataset at a different location and can access the following it using the following command: (Suppose the dataset is stored inside the folder Data101_Tutorials on the desktop)
    - For Windows Users.
