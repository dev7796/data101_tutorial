...
### Snippet 13: What is most frequent profession of people with people with less than 10 years od of education?
...
example14_data = table(subset(census_data, PROFESSION == "Exec-managerial")$EDUCATION)
example14_data
```
