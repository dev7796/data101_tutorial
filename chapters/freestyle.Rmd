...
Bar graph of average CaloriesDanc per Music played.

```{r,tut=TRUE,height=500}
party<-read.csv("https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/dataset/Partyb.csv")
colors<- c('red','blue','cyan','yellow','green') # Assigning different colors to bars

t<-tapply(party$CaloriesDanc, party$Music, mean)

barplot(t, xlab="Type of music",ylab="Calories per dance",col=colors, ylim = c(0,300),
        main="Barplot for music and calories per dance distribution",border="black")
...
Histogram of imdb scores for High Gross movies?

```{r,tut=TRUE,height=500}
movies<-read.csv("https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/dataset/Movies2022F-4.csv")
colors<- c('red','blue','cyan','yellow','green') # Assigning different colors to bars

HighGross <- movies[movies$Gross=='High',]$imdb_score
HighGross
hist(HighGross)
...
boxplot(grades$Exams ~ grades$Grade, xlab="Grades",ylab="Exam Score",col=colors, 
        main="Boxplot for Exam score and grade distribution",border="black")
...
Mosiac plot to check market of beer w.r.t. location.

```{r,tut=TRUE,height=500}
market<-read.csv("https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/dataset/HomeworkMarket2022.csv")
colors<- c('red','blue','cyan','yellow','green') # Assigning different colors to bars

t<-table(market$Beer, market$Location)

mosaicplot(t, xlab="Type of Beer",ylab="Location",col=colors, 
        main="Mosaic plot for Beer and Location distribution",border="black")
...
boxplot(titanic$Fare~titanic$Survived, xlab="Survived",ylab="Fare",col=colors, 
        main="Box plot for survived and fare distribution",border="black")
