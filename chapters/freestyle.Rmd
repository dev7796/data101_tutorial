...
moody<-read.csv("https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/dataset/3_1.csv") #web load

# Question
moody[sample(1:nrow(moody),1), ]['question']

# Answer
moody[sample(1:nrow(moody),1), ]['answer']
...
**One can still fail the class with the score of 82 (sounds familiar, yes, Professor Moody would do it, but Canvas?**   
