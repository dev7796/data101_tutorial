...
df<-read.csv("https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/dataset/3_1.csv") #web load

# Question
q <- df[sample(1:nrow(df),1), ]$question
q 

answer <- df$answer[df$question == q]
answer
