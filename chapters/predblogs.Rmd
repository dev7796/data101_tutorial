...
Based on the way data was generated, the prediction model can be built. We call it the perfect prediction model, since it is constructed with knowledge how data was generated. This model follows the following tree:
...
The code below implements perfect prediction model using the above prediction model rules 
