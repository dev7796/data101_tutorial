...
In section \@ref(dbds) we already introduced the concept of  a sample. For educational purposes we assume that we also know the universe from which sample was taken. This of course happens very rarely, if at all. Usually we do not know the universe.  
