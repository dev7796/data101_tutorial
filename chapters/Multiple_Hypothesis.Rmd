...
hindex<-read.csv("https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/dataset/Temperatures.csv") #web load
# head(moody)
temp<-knitr::kable(
...
## Snippet 1 {#snippet1}
```{r,echo=FALSE}
Temp <-read.csv("https://raw.githubusercontent.com/dev7796/data101_tutorial/main/files/dataset/Temperatures.csv") #web load

PermutationTestSecond::Permutation(Temp, "Township", "Temprature",10000, "Princeton", "Trenton")
PermutationTestSecond::Permutation(Temp, "Township", "Temprature",10000, "Passaic", "Newark")
PermutationTestSecond::Permutation(Temp, "Township", "Temprature",10000, "Ocean Grove", "New Brunswick")
PermutationTestSecond::Permutation(Temp, "Township", "Temprature",10000, "New Brunswick", "Holmdel")
PermutationTestSecond::Permutation(Temp, "Township", "Temprature",10000, "Red Bank", "Holmdel")
```
<!--
