...
## Snippet 10: Freestyle +  rpart: Combining rpart prediction models
...
## Snippet 12: Your Model with rpart
...
#In this example (similarly to snippet 16.6 where we combine two rpart models, we assume that initial split we decided on is based on SCORE. But instead of having two rpart models  (16.6), we will use our prediction  model from prediction challenge 1  for SCORE >50 and rpart for SCORE <=50.
