...
- **Library functions: ** chisq.test() \@ref(chitest), pnorm() \@ref(pnorm), Permutation() \@ref(ptest)
...
- **Lecture slides: **     <button class="btn btn-primary" data-toggle="collapse" data-target="#dt12">Decision Trees </button> 
